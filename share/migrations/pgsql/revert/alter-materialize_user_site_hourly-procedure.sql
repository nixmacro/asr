-- Revert asr:change-materialize_user_site_hourly-procedure from pg

BEGIN;

DROP FUNCTION materialize_user_site_hourly(date, boolean, varchar);
DROP FUNCTION materialize_user_site_hourly(date, date, boolean, varchar);

...
$t->post_ok('/api/admin/tags', json => {name => $test_role_name, invalid => 'invalid'})
...
$t->post_ok('/api/admin/tags', json => {name => $test_tag_name, info => $test_tag_info})
...
$t->get_ok('/api/admin/tags?sort=id.desc')
   ->status_is(200, 'got correct status code')
   ->json_has('/_links/self/href')
   ->json_is('/_links/self/templated' => Mojo::JSON::true)
   # ->json_has('/_links/search/href')
...
$t->get_ok('/api/admin/tags?sort=name.desc')
   ->status_is(200, 'got correct status code')
   ->json_has('/_links/self/href')
   ->json_is('/_links/self/templated' => Mojo::JSON::true)
   # ->json_has('/_links/search/href')
...
$t->get_ok('/api/admin/tags?sort=invalid.desc')
   ->status_is(400, 'should get invalid request due to invalid column')
   ->json_has('/status')
   ->json_has('/message')
   ->json_has('/timestamp');

$t->get_ok('/api/admin/tags?sort=name.desc&size=1&index=1')
   ->status_is(200, 'got correct status code')
   ->json_has('/_links/self/href')
   ->json_is('/_links/self/templated' => Mojo::JSON::true)
   # ->json_has('/_links/search/href')
...
$t->get_ok('/api/admin/tags?sort=name.desc&size=1&index=2')
   ->status_is(200, 'got correct status code')
   ->json_has('/_links/self/href')
   ->json_is('/_links/self/templated' => Mojo::JSON::true)
   # ->json_has('/_links/search/href')
...
$t->get_ok('/api/admin/tags?size=invalid')
   ->status_is(400, 'should get invalid request due to invalid column')
   ->json_has('/status')
   ->json_has('/message')
   ->json_has('/timestamp');

$t->get_ok('/api/admin/tags?index=invalid')
   ->status_is(400, 'should get invalid request due to invalid column')
   ->json_has('/status')
   ->json_has('/message')
   ->json_has('/timestamp');
